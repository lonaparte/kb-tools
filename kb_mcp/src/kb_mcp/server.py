...
def _positive_int(value: str) -> int:
    ...
    Rejects negatives and zero with a clean ArgumentTypeError so
    callers don't silently get bogus results (empty windows,
    zero-size batches, etc.).
    """
    try:
        n = int(value)
...
def link_citations() -> str:
    ...
    """
    return _cmd_link_citations_impl()
...
def _cmd_link_citations_impl() -> str:
    try:
